...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const routes = [
    ...
    { path: "/demo", priority: 0.9, changeFreq: "weekly" as const },
    { path: "/compare", priority: 0.8, changeFreq: "monthly" as const },
    ...
    { path: "/docs/how-it-works", priority: 0.85, changeFreq: "weekly" as const },
    { path: "/docs/integrate", priority: 0.85, changeFreq: "weekly" as const },
    { path: "/docs/ats-1", priority: 0.85, changeFreq: "weekly" as const },
